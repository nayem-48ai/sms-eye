...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val content = LinearLayout(this).apply { orientation = LinearLayout.VERTICAL; setBackgroundColor(Color.WHITE) }
        ...
        val modeSpinner = Spinner(this).apply { adapter = ArrayAdapter(this@MainActivity, android.R.layout.simple_spinner_dropdown_item, arrayOf("Telegram Only", "Firestore Only", "Both")) }
        ...
        val fbScriptInput = createInput("Paste Firebase Script Here", prefs.getString("fb_script", ""))

        // Whitelist Filter
        val filterTitle = TextView(this).apply { text = "Sender Filter List"; setPadding(0, 40, 0, 10) }
        ...
        val editBtn = Button(this).apply { text = "Edit Configuration"; setBackgroundColor(Color.BLUE); setTextColor(Color.WHITE) }
        ...
        editBtn.setOnClickListener {
            if (!isEditMode) {
                ...
                toggle(true, tokenInput, chatInput, fbScriptInput, statusSwitch, addBtn)
            } else {
                ...
                prefs.edit().apply {
                    ...
                    putString("bot_token", tokenInput.text.toString()); putString("chat_id", chatInput.text.toString())
                ...
                toggle(false, tokenInput, chatInput, fbScriptInput, statusSwitch, addBtn)
    ...
    private fun showAbout() = AlertDialog.Builder(this).setTitle("SMS Eye").setMessage("Version 3.2\nFirestore Enabled").show()
    private fun createInput(h: String, v: String?) = EditText(this).apply { hint = h; setText(v); setPadding(20, 30, 20, 30) }
    private fun toggle(e: Boolean, vararg v: View) { v.forEach { it.isEnabled = e } }
}
